...
var RolesTable = &rolesTableType{
	s: parse.StructInfo{Type: "Roles", SQLSchema: "", SQLName: "roles", Fields: []parse.FieldInfo{{Name: "ID", Type: "int32", Column: "id"}, {Name: "Role", Type: "string", Column: "role"}}, PKFieldIndex: 0},
	z: new(Roles).Values(),
}
...
func (s Roles) String() string {
	...
	res[1] = "Role: " + reform.Inspect(s.Role, true)
